...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.OperationClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 156,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Rezervations.Admin"
                        },
                        new
                        {
                            Id = 157,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Rezervations.Read"
                        },
                        new
                        {
                            Id = 158,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Rezervations.Write"
                        },
                        new
                        {
                            Id = 159,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Rezervations.Create"
                        },
                        new
                        {
                            Id = 160,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Rezervations.Update"
                        },
                        new
                        {
                            Id = 161,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Rezervations.Delete"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.Rezervation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5cc555d9-8504-405e-ab9f-d91592dd53c7"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 103, 119, 198, 247, 81, 41, 144, 13, 65, 235, 25, 100, 154, 47, 82, 226, 79, 46, 119, 84, 236, 66, 247, 17, 181, 45, 252, 138, 23, 175, 128, 224, 157, 83, 193, 242, 158, 138, 161, 54, 181, 132, 152, 11, 165, 196, 76, 21, 242, 104, 87, 20, 27, 214, 255, 171, 131, 182, 186, 169, 13, 57, 102, 245 },
                            PasswordSalt = new byte[] { 7, 240, 233, 10, 80, 163, 176, 207, 184, 20, 143, 48, 248, 208, 171, 26, 50, 253, 178, 195, 246, 94, 45, 163, 109, 76, 124, 97, 230, 235, 130, 122, 17, 240, 176, 229, 91, 68, 47, 53, 118, 136, 71, 227, 196, 241, 99, 141, 15, 248, 186, 48, 184, 178, 183, 98, 99, 214, 97, 90, 226, 43, 201, 169, 44, 104, 20, 82, 203, 113, 252, 123, 52, 46, 254, 133, 222, 237, 147, 41, 182, 123, 234, 240, 59, 118, 239, 167, 14, 129, 253, 154, 71, 147, 131, 76, 184, 74, 109, 248, 30, 188, 161, 200, 77, 220, 48, 191, 212, 173, 42, 33, 171, 228, 192, 224, 89, 72, 171, 168, 131, 164, 172, 181, 76, 252, 183, 192 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("339cf8d7-d2ff-4068-a4a0-17bb264d408e"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("5cc555d9-8504-405e-ab9f-d91592dd53c7")
                        });
                });
